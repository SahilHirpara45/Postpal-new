...
const AbandonedPackages = ({
  ...
  // console.log(packageActiveData, "packageActiveData AbandonedPackages");
    ...
    if (userActiveData?.userId && user?.role) {
      ...
      try {
        const fetchUserPackages = async () => {
          ...
          const q = user?.role === "Superadmin" ? q1 : q2;
  ...
  console.log(userActiveData, "userActiveData AbandonedPackages");
...
export default AbandonedPackages;
