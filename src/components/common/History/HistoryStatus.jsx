...
export default function HistoryStatus({ historyData }) {
  const handleNext = () => {
      ...
      <Box sx={{ maxWidth: 600 }}>
        <Stepper orientation="vertical">
          {historyData?.map((h, index) => {
            const dateToShow = new Date(h.date?.seconds * 1000).toDateString();
            ...
            return (
              <Step key={index} active>
                ...
                >
                  <Box sx={{ marginLeft: "12px", fontSize: "14px" }}>
                    <span
                    ...
                    ></span>
                    <p>
                      {dateToShow?.toString()} {timeToShow?.toString()}
                    </p>
                  </Box>
                </StepLabel>
                {/* <StepContent>
